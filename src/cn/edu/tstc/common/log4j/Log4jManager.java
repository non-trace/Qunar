package cn.edu.tstc.common.log4j;
...
import cn.edu.tstc.util.OSSystemUtil;
import cn.edu.tstc.util.PropertyWrapper;
import cn.edu.tstc.util.WebContextUtils;
...
public class Log4jManager implements ServletContextListener {
	...
	/**
	   * 创建子系统的框架日志文件目录
	   * @param srcPath 系统存在目录
	   * @param descPath 系统目录下子系统目录
	   */
