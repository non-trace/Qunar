 ...
 * 
 */
package cn.edu.tstc.interceptor;
...
import cn.edu.tstc.exception.BuzServiceException;
import cn.edu.tstc.util.ToolUtil;
...
public class ManagerActionInterceptor implements Interceptor {
	...
	private String exceptionProcess(HttpServletRequest request,
			HttpServletResponse response, ActionInvocation arg0, Throwable ex) {
